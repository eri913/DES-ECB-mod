...
public class EncryptMethod {
	...
	//Left Circular Shift
	public static int[] leftShift(int[] table, int n) {

		int[] LCS = new int[table.length];
		if(n == 1) {	
			LCS[table.length-1] = table[0];
		...
		{
			LCS[table.length-2] = table[0];
			LCS[table.length-1] = table[1];
